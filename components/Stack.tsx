...
const stackItems = [
    ...
    { id: 6, name: 'Flutter', icon: '', color: '#123456' } 
]
    ...
    return (
      <section id="stack" className="py-16 glass">
        <div className="max-w-[1200px] mx-auto px-4 text-center">
          <h2 className="text-5xl text-gray-200 font-bold mb-4">Minha Stack</h2>
            ...
            {stackItems.map((item) => (
              <div key={item.id} className="flex items-center justify-center flex-col rounded-xl">
                <div className="mb-4 bg-white/10 p-6 rounded-2xl">
                  {item.name === 'Flutter' ? (
                    <img src="/flutter.svg" alt="Flutter Icon" className="w-32 h-32" />
                  ) : (
